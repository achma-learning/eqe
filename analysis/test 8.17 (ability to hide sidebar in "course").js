...
// @version      8.17
// @description  ←→↑↓ nav • T/8 loadouts • Space/Enter check • H sidebar (works on course page too) • F fullscreen • P session timer • Shift+? help • Auto-advance HUD island • Course switcher (M) • Dashboard 1-9 nav • Pomo page-glow • Course page: hide images + compact layout
